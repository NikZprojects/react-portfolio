...
const projects = [
  {
    ...
    description:
      "A habit tracker built with the ability to save data thanks to Google authentication, an Express API, and a MongoDB database.",
  ...
  },
  {
    ...
    imgsrc: "img/cookwithchemistry.jpg",
